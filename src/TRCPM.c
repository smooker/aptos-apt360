/* TRCPM.f -- translated by f2c (version 20000121).
...
#define irr ((integer *)&a3fxi1_1)
    extern /* Subroutine */ int plot_(), tsfmpt_(), tsfmvc_(), avnorm_();

/* ...  *** THIS PROGRAM CREATED FOR VERSION 4, MODIFICATION 0 *** */
/* ******************************************************************** */

/* ...    TRCPM CHECKS FOR TRACUT OR COPY IN EFFECT AT TIME OF */
/* ...    VTLAXS, AND CALLS FOR TRANSFORMATION OF POINT AND TLAXIS */
/* ...    VECTOR.  CALLED FROM VTLAXS AND COMPU2 WHEN PROCESSING */
/* ...    FROM AND GOTO RECORDS. */
/* ...    ARGUMENT (I) IS SUBSCRIPT OF TAPSTO INDICATING */
/* ...    THE X COORDINATE OF POINT TO BE TRANSFORMED. */
/* ...    CHECKS FOR PLOTTING. */
/* *********************************************************************** */
/* ******************************************************************** */
/* ...    IF TRACUT OR COPY IS IN EFFECT, TRANSFORM POINT AND TLAXIS */
