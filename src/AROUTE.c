/* AROUTE.f -- translated by f2c (version 20000121).
...
integer *iret;
{
	...
	char e_1[8];
	real e_2;
	} equiv_2 = { {'A', 'R', 'O', 'U', 'T', 'E', 'T', 'P'}, (float)0. };
...
/*     ASSUME 3D */
    ...
    *iret = 3;
    if (a2cmmn_1.numdim != 0 || a2cmmn_1.i3dflg == 1 || a2cmmn_1.icscnt != 1 
	    || abs(a2cmmn_1.ta[2]) < a2fpc_1.qp4x95 || a2cmmn_1.isftyp[
	    a2cmmn_1.iics - 1] > 4) {
	return 0;
    }
    *iret = 2;
    if (a2cmmn_1.th[a2cmmn_1.ics - 1] != a2fpc_1.qnul) {
	*iret = 3;
    }
    return 0;
} /* aroute_ */
