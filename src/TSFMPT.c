/* TSFMPT.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int tsfmpt_(amatr, pnta, pntp)
doublereal *amatr, *pnta, *pntp;
{
    /* Local variables */
...
/* ...   THIS ROUTINE WILL TRANSFORM A POINT (PNTA) THRU A MATRIX(AMATR)TO */
/* ...   OBTAIN THE TRANSFORMED POINT (PNTP) */
/* *********************************************************************** */
/* ...******************************************************************** */
/* ....******************************************************************* */
/* ....******************************************************************* */
    ...
    /* Function Body */
    a3fxd1_1.pnt[0] = pnta[1];
    a3fxd1_1.pnt[1] = pnta[2];
    a3fxd1_1.pnt[2] = pnta[3];
    for (i__ = 1; i__ <= 3; ++i__) {
	pntp[i__] = amatr[i__ + 12];
	for (j = 1; j <= 3; ++j) {
	    pntp[i__] += a3fxd1_1.pnt[j - 1] * amatr[i__ + j * 3];
/* L10: */
	}
    }
    return 0;
