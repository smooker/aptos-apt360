/* ALLINT.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int allint_(cf1, cf2, pret)
doublereal *cf1, *cf2, *pret;
{
...
/* ...  INTERSECT 2 LINES (CF1,CF2) BY CRAMERS RULE -RETURN PT AS PRET - */
/*     IER = 0 IF OR ,1 IF NOT */
    ...
    /* Function Body */
    det = cf1[1] * cf2[2] - cf2[1] * cf1[2];
    pret[1] = (cf1[3] * cf2[2] - cf2[3] * cf1[2]) / det;
    pret[2] = (cf1[1] * cf2[3] - cf2[1] * cf1[3]) / det;
    a2cmmn_1.ier = 0;
    if (abs(det) < a2fpc_1.qp4x01) {
	a2cmmn_1.ier = 1;
    }
    kk = 3;
    for (i__ = kk; i__ <= 3; ++i__) {
/* L1: */
	pret[i__] = a2fpc_1.qnul;
    }
    return 0;
} /* allint_ */
