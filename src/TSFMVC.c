/* TSFMVC.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int tsfmvc_(amatr, veca, vecp)
doublereal *amatr, *veca, *vecp;
{
    /* Local variables */
...
/* ...   THIS ROUTINE WILL TRANSFORM A VECTOR (VECA) THRU A MATRIX (AMATR) */
/* ...   TO OBTAIN THE TRANSFORMED VECTOR (VECP) */
/* ...           USE..... CALL TSFMVC (AMATR,VECA,VECP) */
/* *********************************************************************** */
/* ...******************************************************************** */
/* ....******************************************************************* */
/* ....******************************************************************* */
    ...
    /* Function Body */
    a3fxd1_1.vec[0] = veca[1];
    a3fxd1_1.vec[1] = veca[2];
    a3fxd1_1.vec[2] = veca[3];
    for (i__ = 1; i__ <= 3; ++i__) {
	vecp[i__] = (float)0.;
	for (j = 1; j <= 3; ++j) {
	    vecp[i__] += a3fxd1_1.vec[j - 1] * amatr[i__ + j * 3];
/* L10: */
	}
    }
    return 0;
